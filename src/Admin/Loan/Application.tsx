    ...
    return (
        <>
            <div className="flex w-full flex-col">
                <Tabs aria-label="Options" selectedKey={FilterData} onSelectionChange={handleTabChange}>
                        ...
                        <div className="w-full flex flex-col gap-4">
                            ...
                            {sizes.map((size) => (
                                <div className="flex w-full flex-wrap md:flex-nowrap mb-6 md:mb-0 gap-4">
                                    ...
                                    {/* <Select
                                        items={LoanServices}
                                        placeholder="Filter Loan Services"
                                        size={'sm'}
                                        onChange={(e: any) => {
                                            setFilterCol(e.target.value);
                                        }}
                                    >
                                        {(LoanServices: any) => <SelectItem key={LoanServices.key}>{LoanServices.label}</SelectItem>}
                                    </Select> */}
                                </div>
                            ))}
                        </div>
