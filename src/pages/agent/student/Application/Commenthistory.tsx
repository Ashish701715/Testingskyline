    ...
    return (
        ...
        >
            <TableHeader>
                ...
                <TableColumn>Comment Subject</TableColumn>
            ...
            >
                ...
                {ApplicationTotal.map((Applicat: any, index: any) => (
                    <TableRow key={index}>
                        ...
                        <TableCell data-column="Comment Subject">{Applicat.COMMENT_RELETED}</TableCell>
                        <TableCell data-column="Comment Description">{Applicat.COMMENT_TEXT}</TableCell>
