    ...
    return (
        <>
            <div className="flex justify-end ">
                <Button className='btn btn-primary mx-2' onClick={() => setRefresh(true)}>Refresh</Button>
                <DocumentAdd />
            </div>
                                                ...
                                                <td>
                                                    {value.DOC_URL == null ? '' :
                                                        <Popover placement="top" content={'View Document'}>
                                                            <NavLink to={value.DOC_URL == null ? '#' : `https://boostupinfinity.in/CRM/API/${value.DOC_URL}`} target='_blank'>
