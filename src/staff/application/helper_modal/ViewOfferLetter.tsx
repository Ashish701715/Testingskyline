                            ...
                            <ModalBody>
                                <div className="flex w-full flex-col">
                                    <Tabs aria-label="Options">
                                        ...
                                        <Tab key="videos" title="Status Management">
                                            <div className="comments-container">
                                                <div className="grid grid-cols-1 md:grid-cols-6 gap-6 overflow-auto">
                                                    {/* Comment Section */}
                                                    <div className="comment-section col-span-3 grid gap-2 border rounded-xl p-2 h-[fit-content] md:h-[fit-content] overflow-auto">
                                                        <div className="comment-list grid gap-0">
                                                            {/* Comment 1 */}
                                                    ...
                                                    {/* Feedback Section */}
                                                    <div className="col-span-3 border rounded-xl" hidden={globalVar.ROLE == 'agent' ? true : false}>
